...
=== Market Board  ===
+---+------------+     +---+------------+     +---+------------+     +---+------------+     +---+------------+     +---+------------+
|idx|  placed    |     |idx|  placed    |     |idx|  placed    |     |idx|  placed    |     |idx|  placed    |     |idx|  placed    |
+---+------------+     +---+------------+     +---+------------+     +---+------------+     +---+------------+     +---+------------+
|  0|  Bu 4      |     |  0|  Kn 88     |     |  0|  An 57     |     |  0|  Sh 48     |     |  0|  Mi 55     |     |  0|  Bu 159    |
|  1|  Sh 94     |     |  1|  Ca 3      |     |  1|  Bu 17     |     |  1|  Bu 144    |     |  1|  Kn 96     |     |  1|  An 13     |
|  2|  Kn 35     |     |  2|  Bu 148    |     |  2|  Sh 37     |     |  2|  An 158    |     |  2|  Bu 264    |     |  2|  Ca 1      |
|  3|  An 63     |     |  3|  Bu 81     |     |  3|  Kn 30     |     |  3|  Mi 67     |     |  3|  Bu 142    |     |  3|  Sh 91     |
+---+------------+     +---+------------+     +---+------------+     +---+------------+     +---+------------+     +---+------------+
...
=== Personal Board ===
                   [ 1:An/6   ] [ 2:Ca/5   ] [ 3:Ca/4   ] [ 4:Kn/3   ]
             [ 5:An/2   ] [ 6:An/1   ] [ 7:Ca/6   ] [ 8:Kn/5   ] [ 9:Bu/4   ]
      [ 10:An/5  ] [ 11:An/4  ] [ 12:Bu/3  ] [ 13:Kn/1  ] [ 14:Bu/2  ] [ 15:Bu/3  ]
[ 16:Sh/6  ] [ 17:Sh/1  ] [ 18:Sh/2  ] ( 19:Ca/6  ) [ 20:Sh/5  ] [ 21:Sh/4  ] [ 22:Sh/1  ]
      [ 23:Bu/2  ] [ 24:Bu/5  ] [ 25:Mi/4  ] [ 26:Bu/3  ] [ 27:Bu/1  ] [ 28:An/2  ]
             [ 29:Bu/6  ] [ 30:Mi/1  ] [ 31:Kn/2  ] [ 32:Bu/5  ] [ 33:Bu/6  ]
                   [ 34:Mi/3  ] [ 35:Kn/4  ] [ 36:Kn/1  ] [ 37:Bu/3  ]

[ id:type/die ]  placed: ()   empty: []  (색상=타입 배경)
...
[1번째 주사위: 1]
현재 일꾼 수 : 2
0) 섹션 1 슬롯 0에서 타일 BUILDING 가져오기
1) 섹션 1 슬롯 1에서 타일 SHIP 가져오기
2) 섹션 1 슬롯 2에서 타일 KNOWLEDGE 가져오기
3) 섹션 1 슬롯 3에서 타일 ANIMAL 가져오기
4) [일꾼 1개 소모] 섹션 6 슬롯 0에서 타일 BUILDING 가져오기
...
20) 일꾼 2개 받기
번호 선택(0~20): 1
=> 실행: 섹션 1 슬롯 1에서 타일 SHIP 가져오기

[2번째 주사위: 5]
현재 일꾼 수 : 2
0) 섹션 5 슬롯 0에서 타일 MINE 가져오기
1) 섹션 5 슬롯 1에서 타일 KNOWLEDGE 가져오기
2) 섹션 5 슬롯 2에서 타일 BUILDING 가져오기
3) 섹션 5 슬롯 3에서 타일 BUILDING 가져오기
4) 저장소[0]의 SHIP 를 cell 20 에 배치
...
20) 일꾼 2개 받기
번호 선택(0~20): 4
=> 실행: 저장소[0]의 SHIP 를 cell 20 에 배치
```
## 구현 기능
### 전체 게임 보드판을 구현한다.
